  ...
  const handleADDToCart = () => {
    setCart((prevState) => [
      ...prevState,
      {
        ...
        active: true, // Adiciona o campo 'active'
      },
    ]);
    Toast.show({
      type: "success",
  ...
  return (
    <View className="bg-white">
      <ScrollView>
        ...
        <TouchableOpacity
          className="bg-white rounded-full absolute mt-10 ml-5 p-2  drop-shadow-xl"
        ...
        <View className="bg-white h-screen rounded-t-3xl -mt-6">
          ...
          <Text className="text-lg font-semibold ml-5 mt-2">
            {produto?.price}
          </Text>
      ...
      <View className="mx-5">
        <TouchableOpacity
          ...
          className="absolute bottom-10 bg-orange-500 w-full py-3 justify-center items-center rounded-lg"
        >
